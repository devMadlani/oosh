    ...
    <div>
      <div className="relative">
        ...
        <div className="container mb-10 flex flex-wrap justify-between mt-8 relative">
          ...
          <img src="/images/Polygon2.png" className="hidden absolute top-[345px] left-96" alt="" />
          
            <img className="absolute hidden md:inline md:right-[180px] lg:right-[290px]" src="/images/Group 20.png" alt="" />
          

        </div>
        <img src="/images/Maskgroup.png" className="absolute bottom-0 image w-[100px]" alt="" />
        <img className="absolute top-32 right-0 w-[60px] md:w-[120px] md:top-1" src="/images/Mask_group.png" alt="" />
        <div className="absolute bottom-0 right-0">
          <img className="w-[220px] md:w-[270px] lg:w-[470px]" src="/images/Group 19.png" alt="" />
        </div>
        ...
        <div className="container">
          <div className="max-w-[1128px] text-center mt-[80px] px-2">
            ...
            <div className="mt-10 text-[rgba(38,35,29,0.8)] text-[14px] px-4">Prioritize your eye health with our gentle eyelid and lash cleanser. Regular use helps prevent irritation, dryness, and buildup, promoting overall eye comfort. Keep your eyes feeling fresh and healthy by incorporating this essential step into your daily hygiene routine.</div>
          </div>
        </div>
      {/* <div className="container flex flex-col gap-6 justify-around mt-20">
        <div className="flex">
          <div className="w-[264px] h-[244px] border border-[rgba(38,35,29,0.1)]">
